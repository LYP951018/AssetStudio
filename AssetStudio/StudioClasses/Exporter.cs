...
//                        break;
//                }
//                var exportFullName = exportPathName + asset.FullName + "." + ext.ToLower();
...
//            else
//            {
//                var exportFullName = exportPathName + asset.FullName + m_Texture2D.GetExtensionName();
//                if (ExportFileExists(exportFullName))
//                    return false;
...
//            {
//                var exportFullName = exportPath + asset.FullName + ".wav";
//                if (ExportFileExists(exportFullName))
//                    return false;
...
//            else
//            {
//                var exportFullName = exportPath + asset.FullName + asset.extension;
//                if (ExportFileExists(exportFullName))
//                    return false;
...
//        public static bool ExportFont(AssetPreloadData asset, string exportPath, Dictionary<string, int> sharedFileIndex, List<AssetsFile> assetsfileList)
//        {
//            var m_Font = new UFont(asset, true, sharedFileIndex, assetsfileList);
...
//        //public static bool ExportMesh(AssetPreloadData asset, string exportPath, Dictionary<string, int> sharedFileIndex, List<AssetsFile> assetsfileList)
//        //{
...
//                    break;
//            }
//            var exportFullName = exportPath + asset.FullName + "." + type.ToLower();
//            if (ExportFileExists(exportFullName))
//                return false;
...
//        {
//            var exportFullName = exportPath + asset.FullName + ".dat";
//            if (ExportFileExists(exportFullName))
//                return false;
...
//            exportPath = exportPath + Studio.FixFileName(animator.FullName) + ".fbx";

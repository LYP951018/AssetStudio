...
//    {
//        public static void WriteFBX(string path, List<AssetsFile> assetsfileList, List<AssetPreloadData> exportableAssets, 
//            string FBXfile, List<GameObject> gameObjects)
//        {
//            var timestamp = DateTime.Now;
//            Dictionary<string, Dictionary<string, string>> jsonMats = null;
//            if (File.Exists(path + "\\materials.json"))
//            {
//                using (var reader = File.OpenText(path + "\\materials.json"))
//                {
...
//                                    {
//                                        if (asset.Type == ClassIDReference.Texture2D && asset.FullName == texName)
//                                        {
//                                            TexturePD = asset;
//                                            break;
//                                        }
...
//                    texPathName = Path.GetFullPath(Path.Combine(texPathName, $"{TexturePD.FullName}.png"));//必须是png文件
//                    ob.AppendFormat("\n\tTexture: 7{0}, \"Texture::{1}\", \"\" {{", TexturePD.uniqueID, TexturePD.FullName);
//                    ob.Append("\n\t\tType: \"TextureVideoClip\"");
//                    ob.Append("\n\t\tVersion: 202");
//                    ob.AppendFormat("\n\t\tTextureName: \"Texture::{0}\"", TexturePD.FullName);
//                    ob.Append("\n\t\tProperties70:  {");
//                    ob.Append("\n\t\t\tP: \"UVSet\", \"KString\", \"\", \"\", \"UVChannel_0\"");
//                    ob.Append("\n\t\t\tP: \"UseMaterial\", \"bool\", \"\", \"\",1");
//                    ob.Append("\n\t\t}");
//                    ob.AppendFormat("\n\t\tMedia: \"Video::{0}\"", TexturePD.FullName);
//                    ob.AppendFormat("\n\t\tFileName: \"{0}\"", texPathName);
//                    ob.AppendFormat("\n\t\tRelativeFilename: \"{0}\"", texPathName.Replace($"{Path.GetDirectoryName(FBXfile)}\\", ""));
//                    ob.Append("\n\t}");

//                    ob.AppendFormat("\n\tVideo: 8{0}, \"Video::{1}\", \"Clip\" {{", TexturePD.uniqueID, TexturePD.FullName);
//                    ob.Append("\n\t\tType: \"Clip\"");
//                    ob.Append("\n\t\tProperties70:  {");
...
//                    cb.AppendFormat("\n\n\t;Video::{0}, Texture::{0}", TexturePD.FullName);

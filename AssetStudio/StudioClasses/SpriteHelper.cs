...
//    {
//        public static Bitmap GetImageFromSprite(AssetPreloadData asset, Dictionary<string, int> sharedFileIndex, List<AssetsFile> assetsfileList)
//        {
//            var m_Sprite = new Sprite(asset, true, sharedFileIndex, assetsfileList);
//            if (assetsfileList.TryGetPD(m_Sprite.m_SpriteAtlas, out var assetPreloadData))
//            {
//                var m_SpriteAtlas = new SpriteAtlas(assetPreloadData, sharedFileIndex, assetsfileList);
